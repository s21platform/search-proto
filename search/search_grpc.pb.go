...
const (
	SearchService_GetSociety_FullMethodName       = "/SearchService/GetSociety"
	SearchService_GetUserWithLimit_FullMethodName = "/SearchService/GetUserWithLimit"
)
...
func (c *searchServiceClient) GetSociety(ctx context.Context, in *GetSocietyIn, opts ...grpc.CallOption) (*GetSocietyOut, error) {
	...
	err := c.cc.Invoke(ctx, SearchService_GetSociety_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) GetUserWithLimit(ctx context.Context, in *GetUserWithLimitIn, opts ...grpc.CallOption) (*GetUserWithLimitOut, error) {
	...
	err := c.cc.Invoke(ctx, SearchService_GetUserWithLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SearchService_GetSociety_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SearchService_GetSociety_FullMethodName,
	}
...
func _SearchService_GetUserWithLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SearchService_GetUserWithLimit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
